...
# model_name_or_path = "/home/zhupengyu/FlagAlpha/Llama2-Chinese-13b-Chat"
...
answer_template = """
你是一个金融领域专家，你的任务是回答以下问题。请仔细阅读问题和选项，然后选择正确的答案，解析部分给了解析过程和答案，你只需要加工后根据解析内容，给出正确选项即可，即A,B,C,D，不要给出任何解析过程。
问题: {question}
选项: {choices}
解析: {answer}
...
def main():
    ...
    result_file = os.path.join("results", "Llama3-Chinese-8B_results_注册会计师（CPA）.csv")
    #如果文件不存在，创建文件
